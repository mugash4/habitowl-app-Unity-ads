...
const LoadingScreen = ({ label = 'Loading...' }) => (
  ...
  >
    ...
    <Text style={{ marginTop: 16, fontSize: 16, color: '#6b7280' }}>{label}</Text>
  </View>
);
    ...
    >
      ...
      >
        {state.routes.map((route, index) => {
          ...
          const configuredTab = tabs.find((tab) => tab.routeName === route.name);
          const label = options.tabBarLabel || configuredTab?.label || options.title || route.name;
          const isFocused = state.index === index;
          const iconName = isFocused ? configuredTab?.activeIcon : configuredTab?.icon;
        ...
        <NavigationContainer>
          ...
          >
            ...
            <Stack.Screen
              ...
              options={{ headerShown: false, presentation: 'modal' }}
            />
            <Stack.Screen name="SuspendUser" component={SuspendUserScreen} options={{ headerShown: false }} />
            <Stack.Screen name="UserAnalytics" component={UserAnalyticsScreen} options={{ headerShown: false }} />
          </Stack.Navigator>
        </NavigationContainer>
      </Portal.Host>
    </PaperProvider>
